          ...
          <div className="questionnaire-background-image">
                    ...
                    <li>
                      <label>
                        <input
                          ...
                          onChange={e => setQuestionOne(e.target.value)}
                        ></input>
                        I like to play it by the book but am occasionally open
                        to risks
                      </label>
                    </li>
                    <li>
                    ...
                    <li>
                      <label>
                        <input
                          ...
                          onChange={e => setQuestionTwo(e.target.value)}
                        ></input>
                        The potential of earning moderate returns with the risk
                        of losing some of your initial investment
                      </label>
                    </li>
                    <li>
                      <label>
                    ...
                    <li>
                      <label>
                        <input
                          ...
                          onChange={e => setQuestionTwo(e.target.value)}
                        ></input>
                        The potential of earning maximum returns with the risk
                        of losing up to half of your initial investment
                      </label>
                    </li>
                  </ul>
                </li>
            ...
            <CardWrapper>
              <ol className="risk-assessment-questions" start="3" tabIndex="0">
                <li>
                  <h4>
                    How comfortable are you with fluctuations in the value of
                    your investments?
                  </h4>
                  <ul style={{ "list-style-type": "none" }}>
                    <li>
                    ...
                    <li>
                      <label>
                        <input
                          ...
                          onChange={e => setQuestionThree(e.target.value)}
                        ></input>
                        I would accept a lower, more predictable rate of return
                        as long as my fluctuations in the value of my
                    ...
                    <li>
                      <label>
                        <input
                          ...
                          onChange={e => setQuestionThree(e.target.value)}
                        ></input>
                        I would accept a higher, slightly less predictable rate
                        of return with some fluctuations in the value of my
                        investments
                      </label>
                    </li>
                    <li>
            ...
            <CardWrapper>
              <ol className="risk-assessment-questions" start="4" tabIndex="0">
                <li>
                  <h4>
                    How likely is it that you’ll need access to a large portion
                    of this money earlier than expected?
                  </h4>
                  <ul style={{ "list-style-type": "none" }}>
                    <li>
                      <label>
